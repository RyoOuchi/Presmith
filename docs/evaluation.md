...
This is an evaluation protocol, not a claim that Presmith improves productivity.
...
toolkit. Condition B: provide Presmith and its skill. Supply identical factual
...
exports using the same rubric. Do not use Presmith's own checker as the only judge.
